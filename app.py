...
<div class="main-header">
    ...
    <p>Tác giả: LÝ VĂN THÂN - Trường TH VĨNH THÀNH - ĐT: 0399318078</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - LÝ VĂN THÂN - Trường Tiểu học Vĩnh Thành- ĐT: 0399318078</div>", unsafe_allow_html=True)
